...
//        define ('HOST', 'mysql:host=daw219.sauces.local;dbname=DB219DWESProyectoTema4');
//        define ('USER', 'user219DWESProyectoTema4');
//        define ('PASSWORD', 'paso');
        
        /* Constantes BD Entorno Desarrollo ONE&ONE */
